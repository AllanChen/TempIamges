export const OFFICIAL_MANIFESTS = [
  {
    schemaVersion: 1, id: "com.glance.remove-background", version: "1.0.0", name: "Remove Background",
  ...
  {
    schemaVersion: 1, id: "com.glance.remove-bg-pro", version: "1.0.0", name: "RemoveBG 高级", summary: "图生图高级背景移除，保留精细主体边缘。", author: "Glance",
    ...
    signature: { algorithm: "Ed25519", keyID: "glance-market-2026-01", value: "1dtnWedKShzcSL9wN7kQkrc3OEY_OKwf2hq9FTw_SrsOHVQ4GF45jsnj_G1yCYoPp-pT8vV9TawTlz3mruZFAg" }
  },
  {
    schemaVersion: 1, id: "com.glance.upscale", version: "1.0.0", name: "超分", summary: "图生图超分辨率，提升图片清晰度与细节。", author: "Glance",
    ...
    signature: { algorithm: "Ed25519", keyID: "glance-market-2026-01", value: "xfal8UPGRm-PMR9JpyM40KjjBz-34leUEcHHJ6BaGPwNsg7_rsLdbIHZIEMmNp1UcfvO3EcXhjcyKkYpNy2wDA" }
  }
] as const;
